    ...
    public static class MessageDeserializer extends StdDeserializer<Object> {
        ...
        public Object deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
            ...
            if (messageClass == UserMessage.class) {
                ...
                java.util.List<AssistantMessage.ToolCall> toolCalls =
                    ...
                    try {
                        toolCalls = mapper.convertValue(toolCallsNode,
                                mapper.getTypeFactory().constructCollectionType(
                                        java.util.List.class, AssistantMessage.ToolCall.class));
                    } catch (Exception e) {
                        // 如果转换失败，使用空列表
                ...
                if (responsesNode != null && responsesNode.isArray()) {
                    ...
                    try {
                        List<ToolResponseMessage.ToolResponse> responses =
                                mapper.convertValue(responsesNode,
                                        mapper.getTypeFactory().constructCollectionType(List.class, ToolResponseMessage.ToolResponse.class));
